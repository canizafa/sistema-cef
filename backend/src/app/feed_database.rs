...
pub async fn seed_database(pool: &SqlitePool) -> Result<(), DbError> {
    ...
    // PROFESORES
    sqlx::query("INSERT OR IGNORE INTO profesor (dni_profesor, nombre, genero, estado) VALUES (?, ?, ?, ?)")
        .bind(40123456_i64)
        .bind("juan perez")
        .bind("masculino")
        .bind("alta")
    ...
    // ACTIVIDADES
    sqlx::query("INSERT OR IGNORE INTO actividad (id_actividad, nombre, descripcion) VALUES (?, ?, ?)")
        .bind("ACT001")
        .bind("yoga")
